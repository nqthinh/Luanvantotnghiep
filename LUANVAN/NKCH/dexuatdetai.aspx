<%@ Page Title="" Language="C#" MasterPageFile="~/mainpage.Master" AutoEventWireup="true" CodeBehind="dexuatdetai.aspx.cs" Inherits="NKCH.dexuatdetai" %>
		...
		<div class="panel-heading">
			...
			<div style="padding: 10px 0px 0px 0px;">
				<p class="text-left">
					...
					<asp:Button ID="btndanhsach" runat="server" Text="Đến danh sách đề tài" class="btn btn-space btn-danger hover" OnClick="btndanhsach_Click" CausesValidation="False" />
				</p>
			</div>
		</div>
					...
					<div class="panel panel-default">
						<div class="form-horizontal group-border-dashed">
							...
							<div class="form-group">
								...
								<div class="col-sm-6">
									<asp:TextBox ID="txtTenDeTai" class="form-control input-sm" runat="server" Width="100%" CausesValidation="True"></asp:TextBox><asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="Nhập thông tin tên đề tài" Display="Dynamic" SetFocusOnError="True" ControlToValidate="txtTenDeTai" ForeColor="Red"></asp:RequiredFieldValidator>
								</div>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								...
								<div class="col-sm-6">
									<asp:CheckBoxList ID="chkLVNC" runat="server" DataSourceID="sqldsLVNC" CellPadding="35" CellSpacing="25" CssClass="be-checkbox" DataTextField="LV_TEN" DataValueField="LV_ID" RepeatColumns="2"></asp:CheckBoxList>
								</div>
