<%@ Page Title="" Language="C#" MasterPageFile="~/mainpage.Master" AutoEventWireup="true" CodeBehind="danhsachdetaithuyetminh_quanly.aspx.cs" Inherits="NKCH.danhsachdetaithuyetminh_quanly" %>
...
<ControlStyle CssClass="btn btn-space btn-danger"></ControlStyle>
								...
								<asp:BoundField DataField="TMDT_NOP" HeaderText="Nộp" SortExpression="TMDT_NOP">
								<ItemStyle Width="10%" />
								</asp:BoundField>
								<asp:BoundField DataField="TMDT_TINHTRANG" HeaderText="Tình trạng" SortExpression="TMDT_TINHTRANG" >
								<ItemStyle Width="15%" />
								</asp:BoundField>
							</Columns>
						...
						<asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:connString %>" SelectCommand="DANGKYDETAITHUYETMINH_SELECTALL_DETAINOP" SelectCommandType="StoredProcedure">
							<SelectParameters>
